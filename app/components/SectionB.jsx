...
const SectionB = () => {
  return (
    <section className="w-full  flex flex-col h-auto mb-8">
      <h1 className="font-bold text-[#4b575f] text-4xl block text-center">
...
const SectionB1 = () => {
  return (
    <div className=" px-8 flex flex-col w-full min-h-full justify-center items-center text-center">
...
const SectionB2 = () => {
  return (
    <div className="grid md:grid-cols-3 grid-cols-1 h-auto   w-full  gap-4 p-2 mx-4 place-items-center">
      <Card
